...
export default function Experience({ experiences, propertyTypes, selectedType, popularDestinations }) {
    return (
        <>
        <Head title="Experiences - EzProperty" />
        ...
        <section className="bg-white px-4 sm:px-6 lg:px-8 py-10 pb-16">
            <div className="max-w-[1536px] mx-auto">
                ...
                <div className="flex items-end justify-between mb-6">
                    <div>
                        <h2 className="section-title">All Experiences for you</h2>
                        <p className="section-subtitle">Discover unique things to do and explore</p>
                    </div>
                </div>
                ...
                {experiences && experiences.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-2xl border border-slate-200">
                        ...
                        <p className="text-slate-500 text-lg">No experiences found at the moment.</p>
...
Experience.layout = page => <FrontLayout>{page}</FrontLayout>;